...
def _campaign(root: Path, *, extensions: tuple[str, ...] = ()) -> tuple[WorkflowWorkspace, str]:
    """Run one declaring job to completion in its own workspace."""

    root.mkdir(parents=True)
    workspace = WorkflowWorkspace.initialize(root / "workspace", extensions=list(extensions))
